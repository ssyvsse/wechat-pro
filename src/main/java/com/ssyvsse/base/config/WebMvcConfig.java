...
import com.ssyvsse.base.config.interceptor.CommonIntercepter;
import com.ssyvsse.base.config.interceptor.UrlInterceter;

/**
 * @author llb
 *
 * @Date 2017年11月28日 下午9:05:37
 */
@Configuration
public class WebMvcConfig extends WebMvcConfigurerAdapter {
	...
	@Autowired
	private UrlInterceter urlInterceter;
	...
	public void addInterceptors(InterceptorRegistry registry) {
		registry.addInterceptor(urlInterceter).addPathPatterns("/lott/**");
