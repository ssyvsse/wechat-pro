...
public class MenuManage {
	...
	public static Menu getMenu() throws UnsupportedEncodingException {
		...
		mainBtn1.setName("吃螃蟹");
		mainBtn1.setType("click");
		mainBtn1.setKey("21");
		
		ClickButton mainBtn2 = new ClickButton();
		mainBtn2.setName("上传图片");
		mainBtn2.setType("click");
		mainBtn2.setKey("11");
		
		ComplexButton mainBtn = new ComplexButton();
		mainBtn.setName("功能选择");
		mainBtn.setSub_button(new Button[]{mainBtn1,mainBtn2});
		
		ViewButton mainBtn3 = new ViewButton();
		mainBtn3.setName("百度");
		mainBtn3.setType("view");
		mainBtn3.setUrl(WechatPropUtil.btn22Url.replace("APPID",WechatPropUtil.app_id).replace("REDIRECT_URI", URLEncoder.encode("http://ssyvsse.s1.natapp.cc/","UTF-8")));
		/**
		 ...
		 */
		Menu menu = new Menu();  
		menu.setButton(new Button[] { mainBtn,mainBtn3});
        return menu;  
	}
}
