 ...
 * @author llb
 *
 * @Date 2018年1月14日 上午9:12:26
 *       <p>
 *       将 ApiConfig 绑定到 ThreadLocal 的工具类，以方便在当前线程的各个地方获取 ApiConfig 对象：
 *       1：如果控制器继承自 MsgController 该过程是自动的，详细可查看 MsgInterceptor 与之的配合 2：如果控制器继承自
 *       ApiController 该过程是自动的，详细可查看 ApiInterceptor 与之的配合 3：如果控制器没有继承自
 *       MsgController、ApiController，则需要先手动调用ApiConfigKit.
 *       setThreadLocalApiConfig(ApiConfig) 来绑定 apiConfig 到线程之上
 *       </p>
 */
